...
from test_rag.agents.basic_info.tools import ALL_BASIC_INFO_TOOLS
...
basic_info_agent = Agent(
    ...
    description='강남대학교 건물 위치, 시설 정보, 행정부서 연락처, 캠퍼스 안내 등 기본 정보를 검색합니다.',
    instruction='''
    당신은 강남대학교의 **캠퍼스 안내 전문가**입니다.
    학생들과 자연스럽게 대화하며 캠퍼스와 행정 관련 모든 정보를 제공합니다.
