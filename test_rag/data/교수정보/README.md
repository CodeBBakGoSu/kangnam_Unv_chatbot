...
python test_rag/data/교수정보/create_professor_corpus.py
```
...
#### 2-2. `test_rag/agents/professor/tools/search_tools.py` 파일 수정
```python
# 🔴 이 줄을 찾아서
...
```bash
python test_rag/data/교수정보/upload_professors_to_rag.py
```
...
- Agent 정의: `test_rag/agents/professor/agent.py`
- 검색 도구: `test_rag/agents/professor/tools/search_tools.py`
- Root Agent: `test_rag/agent.py`
