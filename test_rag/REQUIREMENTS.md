...
**사용 위치:**
- `test_rag/agent.py`: Root Agent 정의
- `test_rag/agents/*/agent.py`: 모든 Sub-Agent 정의
- `test_rag/config/__init__.py`: Vertex AI 초기화
...
- `test_rag/agents/subject/tools/subject_tools.py`
  - 강남대학교 강의계획서 시스템 크롤링
...
### 4. python-dotenv
**사용 위치:**
- `test_rag/config/__init__.py`
- `test_rag/deploy.py`
- `test_rag/create_staging_bucket.py`
...
- 관련 파일: `test_rag/agents/graduation/tools/rag_search_tools.py` (사용 안 함)
