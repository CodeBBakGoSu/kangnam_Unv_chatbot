"""
강남대학교 교수정보 Vertex AI Search 데이터 스토어 생성 스크립트

사용법:
    python goole_adk/data/교수정보/create_professor_datastore.py
"""
...
DATA_STORE_ID = "kangnam-univ-professor-info-datastore"  # 고유 ID (RFC-1034 준수)

# ==============================
# 실행
# ==============================
print("=" * 60)
print("🔍 강남대학교 교수정보 Vertex AI Search 데이터 스토어 생성")
print("=" * 60)
...
try:
    ...
    data_store = discoveryengine.DataStore(
        display_name="강남대학교 교수정보 검색 스토어",
    ...
    print("\n📝 다음 단계:")
    print("1️⃣ 교수정보 JSON 파일을 Cloud Storage 버킷에 업로드합니다.")
