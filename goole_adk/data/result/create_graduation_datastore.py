"""
강남대학교 졸업요건 Vertex AI Search 데이터 스토어 생성 스크립트

사용법:
    python goole_adk/data/result/create_graduation_datastore.py
"""
...
DATA_STORE_ID = "kangnam-univ-graduation-requirements-datastore"  # 고유 ID (RFC-1034 준수)

# ==============================
# 실행
# ==============================
print("=" * 60)
print("🎓 강남대학교 졸업요건 Vertex AI Search 데이터 스토어 생성")
print("=" * 60)
...
try:
    ...
    data_store = discoveryengine.DataStore(
        display_name="강남대학교 졸업요건 검색 스토어",
    ...
    print("\n📝 다음 단계:")
    print("1️⃣ kangnam_univ_graduation_requirements.jsonl 파일을 Cloud Storage 버킷에 업로드합니다.")
    print("   gsutil cp kangnam_univ_graduation_requirements.jsonl gs://YOUR_BUCKET/")
    print("2️⃣ 'import_documents' API로 데이터를 데이터스토어에 추가합니다.")
    print("3️⃣ 생성된 데이터스토어를 RAG 코퍼스와 연결합니다.")
    print("\n🔍 메타데이터 검색 가능 필드:")
    print("   - college (대학)")
    print("   - division (계열)")
    print("   - department (학과/전공)")
    print("   - year_range (학년도)")
