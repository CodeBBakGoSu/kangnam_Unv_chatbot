"""
강남대학교 건물/시설 정보 Vertex AI Search 업로드 스크립트

사용법:
    python goole_adk/data/강남대\ 기본정보/upload_building_to_ai_search.py
"""
...
LOCATION = "global"
DATA_STORE_ID = "kangnam-univ-building-info-datastore"

# GCS 버킷 설정
BUCKET_NAME = "kangnam-univ"
GCS_FOLDER = "rag_data/building_info"
LOCAL_FILE = "goole_adk/data/강남대 기본정보/강남대위치정리.jsonl"
...
def import_building_docs():
    """Vertex AI Search에 건물 정보 문서 가져오기"""
    print("\n" + "=" * 60)
    print("📤 Vertex AI Search - 건물정보 JSONL Import 시작")
    print("=" * 60)
