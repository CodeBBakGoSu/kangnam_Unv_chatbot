"""
강남대학교 건물/시설 정보 Vertex AI Search 데이터 스토어 생성 스크립트

사용법:
    python goole_adk/data/강남대\ 기본정보/create_building_datastore.py
"""
...
DATA_STORE_ID = "kangnam-univ-building-info-datastore"  # 고유 ID (RFC-1034 준수)

# ==============================
# 실행
# ==============================
print("=" * 60)
print("🔍 강남대학교 건물/시설 정보 Vertex AI Search 데이터 스토어 생성")
print("=" * 60)
...
try:
    ...
    data_store = discoveryengine.DataStore(
        display_name="강남대학교 건물/시설 정보 검색 스토어",
    ...
    print("\n📝 다음 단계:")
    print("1️⃣ 건물/시설 정보 JSONL 파일을 Cloud Storage 버킷에 업로드합니다.")
    print("2️⃣ 'import_documents' API로 데이터를 데이터스토어에 추가합니다.")
    print("3️⃣ upload_building_to_ai_search.py 스크립트를 실행하세요.")
